        ...
        this.computedPublisherName = new (_electronBuilderUtil || _load_electronBuilderUtil()).Lazy((0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            if (publisherName == null && cscFile != null) {
                if (process.platform === "win32") {
                    try {
                        const subject = (yield (0, (_electronBuilderUtil || _load_electronBuilderUtil()).exec)("powershell.exe", [`(Get-PfxCertificate "${cscFile}").Subject`])).trim().match(/CN=([^,]+)/);
                        if (subject) {
                            return (0, (_electronBuilderUtil || _load_electronBuilderUtil()).asArray)(subject[1]);
                        }
                    } catch (e) {
