...
class PlatformPackager {
    ...
    doPack(outDir, appOutDir, platformName, arch, platformSpecificBuildOptions, targets) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            const macroExpander = function (it) {
                return _this2.expandMacro(it, arch == null ? null : (_electronBuilderCore || _load_electronBuilderCore()).Arch[arch], { "/*": "{,/**/*}" });
            };
    ...
    expandArtifactNamePattern(targetSpecificOptions, ext, arch, defaultPattern) {
        ...
        let archName = arch == null ? null : (_electronBuilderCore || _load_electronBuilderCore()).Arch[arch];
        ...
        } else if (arch === (_electronBuilderCore || _load_electronBuilderCore()).Arch.ia32) {
        ...
        return this.expandMacro(pattern, this.platform === (_electronBuilderCore || _load_electronBuilderCore()).Platform.MAC ? null : archName, {
            ext: ext
        });
    }
