...
class FpmTarget extends (_electronBuilderCore || _load_electronBuilderCore()).Target {
    ...
    build(appOutDir, arch) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            const destination = _path.join(_this2.outDir, _this2.packager.expandArtifactNamePattern(_this2.options, target, arch !== (_electronBuilderCore || _load_electronBuilderCore()).Arch.x64 || isUseArchIfX64 ? arch : null, nameFormat));
