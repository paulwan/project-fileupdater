...
class ArchiveTarget extends (_electronBuilderCore || _load_electronBuilderCore()).Target {
    ...
    build(appOutDir, arch) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            const outFile = _path.join(_this.outDir, packager.expandArtifactNamePattern(_this.options, format, arch === (_electronBuilderCore || _load_electronBuilderCore()).Arch.x64 ? null : arch, packager.platform === (_electronBuilderCore || _load_electronBuilderCore()).Platform.LINUX ? "${name}-${version}-${arch}.${ext}" : "${productName}-${version}-${arch}-${os}.${ext}"));
